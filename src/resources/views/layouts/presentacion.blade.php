...
<div class="row">
  ...
  <div class="col-md-9 col-sm-8">
    ...
    <p>ESCUELA INTERNACIONAL DE DOCTORADO DE LA UNIVERSIDAD DE SEVILLA (EIDUS): <a href="http://www.doctorado.us.es/plan-2011/escuela-internacional-de-doctorado">http://www.doctorado.us.es/plan-2011/escuela-internacional-de-doctorado</a></p>
    <br>
    <br/>
    ...
    @elseif ( $step == 2 )
    <h2>Composición de la Comisión Académica</h2>
    <p class="lead">&nbsp;</p>
    <ul>
      <li>
    ...
    @elseif ( $step == 3 )
    <h2>Datos Coordinador/a del programa</h2>
    <p class="lead">&nbsp;</p>
    <p>Manuel l. de la Mata Benítez. <br>
    Profesor Titular de Universidad. Departamento de Psicología Experimental. <br>Vicedecano de Recursos para el Aprendizaje y la Investigación. <br>Facultad de Psicología.<br><br>
    </p>
   <p>
    Tfno.: (34) 95 455 62 16. <a href="mailto:doctorado_psicologia@us.es">doctorado_psicologia@us.es</a>
    </p>
    <p>
    <a href="https://investigacion.us.es/sisius/sis_showpub.php?idpers=1820">https://investigacion.us.es/sisius/sis_showpub.php?idpers=1820</a>
    </p>

    @else
    <h2>Datos del Servicio de Doctorado</h2>
    <p class="lead">&nbsp;</p>
    <p><a href="http://www.doctorado.us.es">http://www.doctorado.us.es/</a>
    <p>
    Servicio de Doctorado - Pabellón de México,<br> 
    Avenida de la Palmera, s/n. 
    <br>41013 Sevilla 
    <br><a href="http://www.doctorado.us.es/horarios-localizacion">http://www.doctorado.us.es/horarios-localizacion</a>
    </p>
