...
<div class="row">
	...
	<div class="col-md-9 col-sm-8">
		...
		<p>
		<b>OTROS PROFESORES QUE AVALAN LA LÍNEA</b>:<br> Andres García García, Héctor Martínez Sánchez, Patricio O’Donell, Nestor Schmajuk, Eva Mª Trigo Sánchez. Sánchez.
		</p>
		...
		<ul>
			...
			<li>
			Cost Action “Enhancing children's oral language skills across Europe and beyond: a collaboration focusing on interventions for children with difficulties learning their first language [IS1406] Investigador Principal. David Saldaña Sage." <a href="http://www.cost.eu/COST_Actions/isch/Actions/IS1406?management">http://www.cost.eu/COST_Actions/isch/Actions/IS1406?management</a>
			</li>
			<li>
		...
		<p>
		<b>OTROS PROFESORES QUE AVALAN LA LINEA</b>:<br>
		 Francisco Javier Moreno Pérez, Isabel de los Reyes Ortiz Y Joel Talcott (Univ. de Aston, R.U.).
		</p>
		...
		<p>
		<b>OTROS PROFSORES/AS QUE AVALAN LA LINEA</b>:<br> Águeda Parra Jiménez, Inmaculada Sánchez Quejía y  Phillip Slee (Universidad de Flinders, Australia)
		</p>
		...
		<p>
		<b>OTROS/AS PROFESORES/AS QUE AVALAN LA LÍNEA</b>:<br>
		Agustín Martín Rodríguez, Rafael J. Martínez Cervantes, Eva Mª Padilla Muñoz y Carmen del Rio Sánchez.
		</p>
		...
		<p>
		<b>OTROS/AS PROFESORES/AS DE LA LÍNEA</b>:<br> 
		Mercedes Cubero Pérez, Andrés Santamaría Santigosa, Fabricio Balcázar (U. de Illinois); Yolanda Suárez. (U. de Illinois); Douglas Perkins (U. Vanderbilt); David Ingleby (U. Utrecht); Isaac Prilleltensky (Univ. de Manitoba, EEUU, Paul Crawford. (U. de Nottingham); Tia G.B. Hansen. (U. de Aalborg); Kristine Jensen (U. de Aalborg), Geoff Nelson (U. Wilfried Laurier, Canadá), Andrea Smorti (U. de Florencia).
		</p>
