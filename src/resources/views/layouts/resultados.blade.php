...
<div class="row">
	...
	<div class="col-md-9 col-sm-8">
		...
		@if ( $step == 1 )
		<h3>SGCPD</h3><br/>
		Sistema de Garantía de Calidad de los Programas de Doctorado - SGCPD:<br>
		<a href="http://www.doctorado.us.es/sistema-de-garantia-de-calidad">http://www.doctorado.us.es/sistema-de-garantia-de-calidad</a>
		...
		<p>
		En este momento hay matriculados en el Programa de Doctorado en Psicología un total de 53 estudiantes (26 de Primer año y 27 de Segundo). 
		</p>
		<p>
		Los datos de becas, ayudas y contratos de dichos/as estudiantes son:
		</p>
		<ul>
			<li> 
		...
		<ul>
			...
			<li>
			Total de estudiantes internacionales admitidos/as: 11 85 el primer año y 6 el segundo).
			</li>
		</ul>
		...
		<ul>
			<li>
			Buzón general Universidad de Sevilla: <a href="https://institucional.us.es/exponaus/">https://institucional.us.es/exponaus/</a>
			</li>
			<li>
			Buzón específico de doctorado: <a href="http://www.doctorado.us.es/buzon">http://www.doctorado.us.es/buzon</a>
			</li>
		</ul>
